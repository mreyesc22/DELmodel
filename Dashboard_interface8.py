...
tab0, tab1, tab2, tab3, tab4 = st.tabs([
    "Testing-Dashboard", 
    "1 Project Overview", 
    "2 Inlet Volume vs Distance from floodgates", 
...
with tab0:
    ...
    Please read the scenarios, explore the tabs and functionalities.
...
# -------------------------
with tab1:
    st.header("1. Project Overview: Saltwater Management in the Haringvliet Estuary")
    ...
    - Dynamic equilibrium or salt intrusion location (Window 2)
    - Strategy comparisons (Window 3)
    - Uncertainty quantification and recommendations (Window 4)
    """)
...
with tab2:
    ...
    st.header("2. Inlet Volume vs Distance from floodgates")
...
# -------------------------
with tab4:
    st.header("4. Uncertainty Analysis")
